...
public class JavaKafkaProducer {
    ...
    public static void main(String[] args) {
        String brokerList = "192.168.1.8:9092";
...
//        final Producer<String, String> producer = new Producer<String, String>(config);
        ...
        for (int i = 0; i < 5; i++) {
            pool.submit(new Thread(new Runnable() {
                ...
                public void run() {
                    while (flag.get()) {
                        // 发送数据
                        ProducerRecord<String,String> msg = generageKeyMessageByRecord();
    ...
    private static ProducerRecord<String,String> generageKeyMessageByRecord(){
        ...
        return new ProducerRecord<String, String>(TOPIC_NAME, key,message);
    }
